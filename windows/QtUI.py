...
from win import Ui_MainWindow  # 导入ui界面文件
from winDia import Ui_Dialog
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def update_image(self):
        picture = QtGui.QPixmap('./MvImport/show_labelpic/0.jpg')
        self.label_showpic.setScaledContents(True)
        self.label_showpic.setPixmap(picture.scaled(950, 640))
